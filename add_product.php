...
<form method="get" action="add_category.php">
  <div class="mb-3">
    <label class="form-label txt-bold">Product Name: </label>
    <input type="text" class="form-control"   name="ceta__name">
  </div>
  <div class="mb-3">
       <select name="" id="">
           <option value="" selected>Product category</option>
           <option value="">aefgbcd</option>
           <option value="">kloabcd</option>
       </select>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label txt-bold">Product Code :</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="ceta__ent__date">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label txt-bold">Product Entry Date :</label>
